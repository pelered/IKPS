# -*- coding: utf-8 -*-
"""
Created on Mon Jul 15 12:59:28 2019
...
X, Y = create_models.get_data_for_original_model(mode='evaluacija-suhi')
...
fig = plt.figure('Orginal data,1/3,suhi')
...
fig = plt.figure('Orginal data,1-test,suhi')
fig.suptitle('Usporedba rezultata dobivenih za podatke podijeljene 2/3 i 1/3')
ax = fig.add_subplot(111)
